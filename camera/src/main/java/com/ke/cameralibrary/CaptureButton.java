...
import static com.ke.cameralibrary.JCameraView.BUTTON_STATE_BOTH;
import static com.ke.cameralibrary.JCameraView.BUTTON_STATE_ONLY_CAPTURE;
import static com.ke.cameralibrary.JCameraView.BUTTON_STATE_ONLY_RECORDER;
...
public class CaptureButton extends View {
    ...
    private int progress_color = R.color.cameraview_circle_recoder_progress;            //进度条颜色
    private int outside_color = R.color.cameraview_circle_recoder_out;             //外圆背景色
    private int inside_color = R.color.cameraview_circle_recoder_in;              //内圆背景色
    ...
    protected void onDraw(Canvas canvas) {
        ...
        mPaint.setColor(getResources().getColor(outside_color)); //外圆（半透明灰色）
        canvas.drawCircle(center_X, center_Y, button_outside_radius, mPaint);

        mPaint.setColor(getResources().getColor(inside_color));  //内圆（白色）
        canvas.drawCircle(center_X, center_Y, button_inside_radius, mPaint);

        //如果状态为录制状态，则绘制录制进度条
        if (state == STATE_RECORDERING) {
            mPaint.setColor(getResources().getColor(progress_color));
