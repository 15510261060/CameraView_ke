...
import com.ke.cameralibrary.JCameraView.Companion.BUTTON_STATE_BOTH
import com.ke.cameralibrary.JCameraView.Companion.BUTTON_STATE_ONLY_CAPTURE
import com.ke.cameralibrary.JCameraView.Companion.BUTTON_STATE_ONLY_RECORDER
...
class CaptureButton: View {
  ...
  private val progress_color = R.color.cameraview_circle_recoder_progress            //进度条颜色
  private val outside_color = R.color.cameraview_circle_recoder_out             //外圆背景色
  private val inside_color = R.color.cameraview_circle_recoder_in              //内圆背景色
  ...
  private var button_outside_radius: Float  = 0f     //外圆半径
  private var button_inside_radius: Float  = 0f      //内圆半径
  ...
  constructor(context: Context, size: Int) : super(context) {
    ...
    min_duration = 1300              //默认最短录制时间为1.5s
  ...
  private fun handlerUnpressByState() {
    ...
    when (state) {
      //当前是点击按下
      STATE_PRESS -> if (captureLisenter != null && (button_state == BUTTON_STATE_ONLY_CAPTURE || button_state == BUTTON_STATE_BOTH)) {
